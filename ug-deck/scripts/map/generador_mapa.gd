...
func _get_random_resource_for_column(col_index):
	...
	var r = randf()
	if col_index < 3: 
		if r < 0.8: return load("res://scripts/map/clase_interactiva.tres")
		else: return load("res://scripts/map/casilleros.tres") 
		
	elif col_index < 7: 
		if r < 0.5: return load("res://scripts/map/clase_interactiva.tres")
		elif r < 0.7: return load("res://scripts/map/examen_parcial.tres")
		elif r < 0.85: return load("res://scripts/map/kiosko.tres")
		else: return load("res://scripts/map/recreo.tres")
		
	else: 
		if r < 0.6: return load("res://scripts/map/examen_parcial.tres")
		elif r < 0.8: return load("res://scripts/map/kiosko.tres")
		else: return load("res://scripts/map/clase_interactiva.tres")
